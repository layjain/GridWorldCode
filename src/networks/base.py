...
class BaseModel():
    ...
    def __init__(self, config, network_type):
        ...
        self.saver = None
        # delete ./out
        self.dir_output = "./out/"+network_type+"/"+"GridWorld"+"/"+ str(datetime.datetime.utcnow()) + "/"
        self.dir_model = self.dir_save + "/net/" +"GridWorld"+"/"+ str(datetime.datetime.utcnow()) + "/"
    ...
    def number_of_trainable_parameters(self):
        ...
        a=count_number_trainable_params()
        print(a)
        return a 
